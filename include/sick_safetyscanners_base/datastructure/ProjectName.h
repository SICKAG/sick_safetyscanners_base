...
#ifndef SICK_SAFETYSCANNERS_BASE_DATASTRUCTURE_PROJECTNAME_H
#define SICK_SAFETYSCANNERS_BASE_DATASTRUCTURE_PROJECTNAME_H
...
#endif // SICK_SAFETYSCANNERS_BASE_DATASTRUCTURE_PROJECTNAME_H
