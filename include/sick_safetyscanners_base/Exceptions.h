...
public:
     ...
     * 
     */
    explicit runtime_error() : runtime_error(""){};
...
public:
    ...
    * 
    */
    explicit configuration_error() : runtime_error(""){};
     ...
     * \param what_arg A description of the reason for the failure.
     */
    explicit configuration_error(const std::string &what_arg) : runtime_error(what_arg){};
     ...
     * \param what_arg A description of the reason for the failure.
     */
    explicit configuration_error(const char *what_arg) : runtime_error(what_arg){};
};
...
public:
    ...
    */
     ...
     * \param timeout The timeout that has been exceeded represented as timeval-struct. The timeout information is appended as string after the message string.
     */
    explicit timeout_error(const std::string &msg, timeval timeout) : runtime_error(msg)
    {
        std::stringstream ss;
     ...
     * 
     * \param msg A description of the reason for the failure.
     * \param timeout The timeout that has been exceeded represented in boost::posix_time::timeduration. The timeout information is appended as string after the message string.
     */
