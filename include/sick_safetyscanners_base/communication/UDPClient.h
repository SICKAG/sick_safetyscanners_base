...
public:
   ...
   * 
   * 	param Callable 
   * \param callback A callback of variable templated type Callable to support various formats like std::function.
   */
  ...
  */
  ...
  /*!
   * \brief A synchronous function to receive data. This operation is blocking unless the timeout has been exceeded.
   * 
...
private:
  ...
  /*!
   * \brief Internal callback function to transform raw data into a packetBuffer and begin a new receive-cycle. 
   * 
